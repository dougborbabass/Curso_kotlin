package com.douglasborba.motivation.repository
...
class Mock {
    ...
    fun getPhrase(categoryFilter: Int): String {

        val filtered = mListPhrases.filter { (it.category == categoryFilter || categoryFilter == ALL) }
